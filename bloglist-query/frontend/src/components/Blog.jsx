...
const Blog = ({ blog, user, updateBlogs }) => {
    ...
    const handleLike = async () => {
        try {
            ...
            setNotification(dispatch, 'Blog liked', 'success')
            ...
            setNotification(dispatch, 'Error updating likes', 'error')
        }
    }
    ...
    const handleDelete = async () => {
        ...
        if (confirmRemove) {
            try {
                ...
                setNotification(dispatch, 'Blog removed', 'success')
                ...
                setNotification(dispatch, 'Error removing blog', 'error')
            }
        }
    }
